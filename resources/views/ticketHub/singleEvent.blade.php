            ...
            <div class="splide rlr-media--wrapper rlr-media--sidebar rlr-js-thumbnail-media">
              ...
              <div class="splide__track rlr-media__strack">
                <ul id="image-preview-thumb" class="splide__list">
                  <li class="splide__slide rlr-media__image-view">
                    <img class="rlr-media__thumb lazyload" data-src="./assets/images/product-images/thumbs/03.jpg" alt="media image" />
                  </li>
                  <li class="splide__slide rlr-media__image-view">
                    <img class="rlr-media__thumb lazyload" data-src="./assets/images/product-images/thumbs/01.jpg" alt="media image" />
                  </li>
                  <li class="splide__slide rlr-media__image-view">
                    <img class="rlr-media__thumb lazyload" data-src="./assets/images/product-images/thumbs/02.jpg" alt="media image" />
                  </li>
                  <li class="splide__slide rlr-media__image-view">
                    <img class="rlr-media__thumb lazyload" data-src="./assets/images/product-images/thumbs/03.jpg" alt="media image" />
                  </li>
